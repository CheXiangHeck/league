...
export default function page() {
  return (
    <div className="w-full h-full overflow-y-scroll scrollbar-hidden page-progress">
      ...
      <div className="w-full h-full relative p-5 flex items-center justify-between">
      ...
      <div className="w-full h-full flex items-center justify-center">
        <div className="w-[300px] h-[450px] text-black flex flex-col justify-center items-center rounded-3xl bg-white p-10 gap-10">
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <button
              type="button"
              className="bg-[#1efff9] w-fit text-white font-bold p-3 Link-Button after:border-zinc-400"
            >
              Submit
            </button>
          </div>
